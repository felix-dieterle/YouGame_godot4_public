    ...
    match weather:
        WeatherState.CLEAR:
            return {
                "fog_density": 0.0,
                "rain_intensity": 0.0,
                "turbidity": 8.0,  # Clear bright sky (reduced from 10.0)
                "mie_coefficient": 0.003,  # Minimal haze (reduced from 0.005)
                "rayleigh_coefficient": 3.0  # Bright vibrant blue sky (increased from 2.0)
            }
        ...
        WeatherState.HEAVY_FOG:
            return {
                "fog_density": 0.005,
                "rain_intensity": 0.0,
                "turbidity": 18.0,  # Dense atmospheric haze
        ...
        WeatherState.LIGHT_RAIN:
            return {
                ...
                "mie_coefficient": 0.022,  # Moderate clouds (between HEAVY_FOG and HEAVY_RAIN)
